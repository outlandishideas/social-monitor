...
class ConfigController extends BaseController {
	...
	function indexAction() {
		...
		$values = array(
            ...
            'replies_to_number_posts_bad'=>array('label'=>'Bad ratio of replies to number of posts', 'hint'=>'The presence will get a bad score if the ratio of replies to the number of posts from others falls below this number'),
